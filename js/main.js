...
$(window).on("load", function () {
  ...
  /* -----------------------------------
	...
	----------------------------------- */
  $("body").append(
    '<audio loop autoplay volume="1" id="audio-player"><source src="audio/background-music.mp3" type="audio/mpeg"></audio>'
  );
  ...
  if ($("#contact-form").length) {
    $("#contact-form").validate({
      ...
      submitHandler: function (form) {
        const mail = "apurbar06@gmail.com";
        const subject = $("#note").val();
        window.open(`mailto:${mail}?subject=${subject}`, "_blank");
        // $.ajax({
        //     type: "POST",
        //     url: "/mail.php",
        //     data: $(form).serialize(),
